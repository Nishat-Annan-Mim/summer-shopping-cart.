...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-100 to-orange-100 flex items-center justify-center px-4 py-8">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-10 animate__animated animate__fadeInDown">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-1 text-sm">Join SunCart today!</p>
        </div>
